...
export default function Section() {
  ...
  // Track how far this section has scrolled in/out of view
  const { scrollYProgress } = useScroll({
    target: ref,
    offset: ["start end", "end start"], // 0 when section hits bottom, 1 when it leaves top
  });
  ...
  return (
    <motion.section
      ref={ref}
      className="section-padding relative w-full max-w-none text-start overflow-hidden bg-radial from-tertiary to-primary py-12"
    >
      ...
      <div className="container max-w-[90rem] mx-auto">
        <div className="flex items-center">
          ...
          <div className="relative z-10 flex-1">
            <h2 className="font-bold leading-tight lg:leading-[70px] mb-6 lg:mb-8 bg-gradient-to-r from-[#2A1F1D] via-[#7B3306] to-[#461901] bg-clip-text text-transparent">
              10x More Efficient
              <br />
            ...
            <ul className="space-y-4 text-xl lg:space-y-6">
              <li className="flex items-start gap-4 lg:gap-6">
                ...
                >
                  <path
                    ...
                    fill="url(#paint0_linear_check1)"
                  />
                  <defs>
                    <linearGradient
                      id="paint0_linear_check1"
                      x1="29.8414"
                      y1="1.70857"
                      x2="1.25942"
                      y2="1.60308"
              ...
              <li className="flex items-start gap-4 lg:gap-6">
                ...
                >
                  <path
                    d="M35.2467 0.7616C36.2511 1.77707 36.2511 3.42618 35.2467 4.44165L14.6776 25.2384C13.6733 26.2539 12.0422 26.2539 11.0378 25.2384L0.753264 14.84C-0.251088 13.8246 -0.251088 12.1754 0.753264 11.16C1.75762 10.1445 3.38868 10.1445 4.39304 11.16L12.8617 19.7143L31.615 0.7616C32.6194 -0.253867 34.2504 -0.253867 35.2548 0.7616H35.2467Z"
                    fill="url(#paint0_linear_check2)"
                  />
                  <defs>
                    <linearGradient
                      id="paint0_linear_check2"
                      x1="29.8414"
                      y1="1.70857"
                      x2="1.25942"
                      y2="1.60308"
              ...
              <li className="flex items-start gap-4 lg:gap-6">
                ...
                >
                  <path
                    d="M35.2467 0.7616C36.2511 1.77707 36.2511 3.42618 35.2467 4.44165L14.6776 25.2384C13.6733 26.2539 12.0422 26.2539 11.0378 25.2384L0.753264 14.84C-0.251088 13.8246 -0.251088 12.1754 0.753264 11.16C1.75762 10.1445 3.38868 10.1445 4.39304 11.16L12.8617 19.7143L31.615 0.7616C32.6194 -0.253867 34.2504 -0.253867 35.2548 0.7616H35.2467Z"
                    fill="url(#paint0_linear_check3)"
                  />
                  <defs>
                    <linearGradient
                      id="paint0_linear_check3"
                      x1="29.8414"
                      y1="1.70857"
                      x2="1.25942"
                      y2="1.60308"
          ...
          <div className="relative max-w-2xl max-h-[450px] flex justify-center items-center">
            <motion.img
              style={{ y: imageY }}
              ...
              className="object-cover w-full h-auto -rotate-[10deg]"
            />
          </div>
        </div>
      </div>
