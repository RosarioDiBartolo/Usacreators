...
export const Component = () => {
  ...
  return (
    <>
      ...
      <div className="w-full max-w-xl relative overflow-hidden flex items-center justify-center">
        {/* Background gradient */}
        <div className="absolute  inset-0  z-0" />
        
        {/* Scrolling images container */}
        <div className="relative   z-10 w-full flex items-center justify-center">
          <div className="scroll-container py-20 w-full ">
            <div className="infinite-scroll flex gap-6 ">
              {duplicatedImages.map((image, index) => (
                <div
                  key={index}
                  className="image-item flex-shrink-0 w-48 h-48 md:w-96 md:h-96 lg:w-80 lg:h-80 rounded-xl overflow-hidden shadow-2xl"
                >
                  <img
                    src={image}
