        ...
        {faqItems.map((item) => {
          ...
          return (
            <AccordionItem
              key={item.id}
              value={item.id}
              className="   rounded-lg  overflow-hidden transition-all duration-300 hover:border-accent/40 hover:shadow-lg hover:bg-linear-to-br hover:from-accent/10 hover:to-accent/15"
            >
              <AccordionTrigger
                className="
                text-lg
